...
namespace LootShop {
	public class MyShopMenu : GenericMenu {
		public MyShopMenu()
			...
			entryManageInventory.Content = new TextBlock("Manage your shop's inventory. #ACTION_0#");
			MenuEntries.Add(entryManageInventory);

			Entry entryOpenShop = new Entry("Open Shop");
			entryOpenShop.Content = new TextBlock("Open your shop for business! Can't be done at night. #ACTION_1#");

...
namespace LootShop {
	class CutsceneScreen : GameScreen {
		Cutscene Cutscene = new Cutscene(new List<DialogueBox>() {
			new DialogueBox(new TextBlock("The path of #C_SPECIAL# the righteous man #C_NORMAL# is beset on all sides by the iniquities of the selfish and the tyranny of evil men."), "Samuel L. Jackson"),

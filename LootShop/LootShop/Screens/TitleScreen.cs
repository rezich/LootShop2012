...
namespace LootShop {
	class TitleScreen : GameScreen {
		public override void Draw(GameTime gameTime) {
			...
			ScreenManager.SpriteBatch.DrawString(LootShop.CurrentGame.UIFontMedium, title, new Vector2(ScreenManager.GraphicsDevice.Viewport.Width / 2, ScreenManager.GraphicsDevice.Viewport.Height / 2 - 13), Color.White, 0.0f, LootShop.CurrentGame.UIFontMedium.MeasureString(title) / 2, 1.0f, SpriteEffects.None, 0.0f);
			ScreenManager.SpriteBatch.DrawString(LootShop.CurrentGame.UIFontSmall, pressStart, new Vector2(ScreenManager.GraphicsDevice.Viewport.Width / 2, ScreenManager.GraphicsDevice.Viewport.Height / 2 + 11), Color.Lerp(Color.Yellow, Color.Black, (float)Math.Sin(gameTime.TotalGameTime.TotalSeconds * 5)), 0.0f, LootShop.CurrentGame.UIFontSmall.MeasureString(pressStart) / 2, 1.0f, SpriteEffects.None, 0.0f);
